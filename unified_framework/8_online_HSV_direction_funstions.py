...
Dir = '/home/omari/Python/Python_images/language_and_vision/images/'

#============================== Constants ======================================#


tests = 1			# for monte carlo test
n_examples = 251		# number of examples in each test
	...
	#========================== MAIN LOOP ====================================#
		...
		for i in range(n_examples):
			...
			if hyp['objects_hyp'][0] != []:
				#print '========================'
				POINTS_SPA = Update_SPA_points(o_qsr,POINTS_SPA)		# update the histogram of SPA
...
#===========##============##===========$$============##===========##==============#	WITH CK
			...
			if (i+1)%display_frame == 0:
				...
				Plotting_HSV_hypotheses(hyp,ax_HSV,i)
				Plotting(POINTS_HSV,ax_HSV,-45,4,35,'HSV',i)

				#Plotting_SPA_hypotheses(hyp,ax_SPA)
				Plotting_dis_hypotheses(hyp,ax_DIS,i)
				Plotting(POINTS_SPA,ax_DIS,135,5,65,'Distance',i)

				Plotting_dir_hypotheses(hyp,ax_DIR,i)
				Plotting(POINTS_SPA,ax_DIR,135,6,65,'Direction',i)
			...
			if 'valid_dis_hyp' in hyp:
			    for hh in hyp['valid_dis_hyp']:
				    print hh,hyp['hyp'][hh]['counter_dis']
			if 'valid_HSV_hyp' in hyp:
			    for hh in hyp['valid_HSV_hyp']:
				    print hh,hyp['hyp'][hh]['counter_HSV']
			if 'valid_dir_hyp' in hyp:
			    for hh in hyp['valid_dir_hyp']:
				    print hh,hyp['hyp'][hh]['counter_dir']
