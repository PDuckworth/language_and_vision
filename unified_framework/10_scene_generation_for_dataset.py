...
if __name__ == "__main__":
	...
	#========================== MAIN LOOP ====================================#
		...
		for i in range(n_examples):
			...
			map_size = 500
			img2 = np.zeros(shape=(map_size, map_size*3, 3), dtype=np.uint8)+255 
			img2[0:map_size,0:map_size,:]=img
			# drow lines for description
			img2[98:100,map_size+40:3*map_size-10,:] = [0,0,0]
			img2[198:200,map_size+40:3*map_size-10,:] = [0,0,0]
			img2[298:300,map_size+40:3*map_size-10,:] = [0,0,0]
			img2[398:400,map_size+40:3*map_size-10,:] = [0,0,0]
			img2[498:500,map_size+40:3*map_size-10,:] = [0,0,0]
			cv2.imshow('Table',img2)
