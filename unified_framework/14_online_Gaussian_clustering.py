...
Dir = '/home/omari/Python/language/Simultaneous_learning_and_ground/images/'

#============================== Constants ======================================#


tests = 1			# for monte carlo test
n_examples = 1500		# number of examples in each test
plotting = 1			# choose to plot graphs or not
time = 1			# time to view each example
object_number_max = 3		# maximum number of objects allowed in one scene
...
if __name__ == "__main__":
	...
	#========================== MAIN LOOP ====================================#
		...
		for i in range(n_examples):
			...
			hyp = Update_HSV_Points(hyp,o_color,i)		# update the histogram of HSV
...
#===========##============##===========$$============##===========##==============#	WITH CK
				...
				#Plotting(POINTS_HSV,ax_HSV,180,4,25,'HSV',i)
		...
		data1['hyp'] = hyp
		output = open('/home/omari/'+str(n_examples)+'.pkl', 'wb')
		print ' - saving data..'
