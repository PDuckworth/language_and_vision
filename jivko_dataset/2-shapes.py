...
class shapes():
    ...
    def __init__(self):
        self.dir = "/home/omari/Datasets/jivko_dataset/objects/"
        self.dir_save = "/home/omari/Datasets/jivko_dataset/features/shapes/"
        self.th = 10
        self.sp = 2
        self.X = []     # fpfh vales
    ...
    def _read_shapes(self):
        for t in range(1,5):
            for o in range(1,33):
                f1 = self.dir+"obj_"+str(t)+"_"+str(o)+"_fpfh.pcd"
                f2 = self.dir+"obj_"+str(t)+"_"+str(o)+".txt"
                f3 = self.dir+"obj_"+str(t)+"_"+str(o)+"_gfpfh.pcd"
                im = self.dir+"obj_"+str(t)+"_"+str(o)+".jpg"
                img = cv2.imread(im)
                self.images.append(cv2.resize(img, (self.im_len,self.im_len), interpolation = cv2.INTER_AREA))
                #self.images.append(cv2.imread(im))
                num=1
                fpfh = 0
                ...
                f.close()
        pickle.dump( [self.shapes, self.GT, self.X, self.gX, self.eX], open("/home/omari/Datasets/jivko_dataset/features/shapes/shapes.p", "wb" ) )
    ...
    def _print_results(self):
        ...
        true_labels = self.GT
        pred_labels = self.Y_
        print "\n number of clusters:", len(set(true_labels))
