...
from videos_segmented_by_day import segmented_videos, random_segmented_videos
...
if __name__ == "__main__":
    ...
    # videos_by_day = random_segmented_videos()   # random
    ...
    olda = OnlineLDA(vocab, K, D, alpha, eta, tau0, kappa, updatect)
