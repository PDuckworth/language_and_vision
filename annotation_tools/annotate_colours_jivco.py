...
class gui():
    ...
    def __init__(self):
        ...
        self.dir1 = "/home/omari/Datasets/jivko_dataset/objects/obj_"+str(self.t)
        self.root = tk.Tk()
        ...
        self.button3 = tk.Button(self.root, text="blue", command=self.blue)
        self.button3.grid(row=2, column=0, columnspan=1, pady=5, padx=2, sticky="ew")
        self.button4 = tk.Button(self.root, text="brown", command=self.brown)
        self.button4.grid(row=3, column=0, columnspan=1, pady=5, padx=2, sticky="ew")
        self.button5 = tk.Button(self.root, text="yellow", command=self.yellow)
        self.button5.grid(row=4, column=0, columnspan=1, pady=5, padx=2, sticky="ew")
        self.button6 = tk.Button(self.root, text="pink", command=self.pink)
        self.button6.grid(row=5, column=0, columnspan=1, pady=5, padx=2, sticky="ew")
        self.button7 = tk.Button(self.root, text="orange", command=self.orange)
    ...
    def save(self):
        ...
        for t in range(1,5):
            fname = self.dir_saving+'obj_'+str(t)+"_"+str(self.folder)+'_colour.txt'
            ...
            self.file_com.write(self.object)
            self.file_com.close()
            # print self.object
    ...
    def red(self):
        self.object = 'red'; self.save(); print 'red'
    def green(self):
        self.object = 'green'; self.save(); print 'green'
    def blue(self):
        self.object = 'blue'; self.save(); print 'blue'
    def brown(self):
        self.object = 'brown'; self.save(); print 'brown'
    def yellow(self):
        self.object = 'yellow'; self.save(); print 'yellow'
    def pink(self):
        self.object = 'pink'; self.save(); print 'pink'
    def orange(self):
        self.object = 'orange'; self.save(); print 'orange'
    # def Sink(self):
    ...
    def PrevVideo(self):
        ...
        while(1):
            ...
            if not os.path.isfile(fname):
                ...
                self.folder -= 1
        # self.dir2 = self.dir1+'_'+str(self.folder)+'_colour.jpg'
        print 'processing vid num:',self.folder
        self.onlyfiles = [self.dir1+'_'+str(self.folder)+'_colour.jpg']
        self.f1 = 1
        # self.check_file()
