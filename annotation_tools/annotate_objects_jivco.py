...
class gui():
    ...
    def __init__(self):
        ...
        self.button2 = tk.Button(self.root, text="pen", command=self.pen)
        self.button2.grid(row=1, column=0, columnspan=1, pady=5, padx=2, sticky="ew")
        self.button3 = tk.Button(self.root, text="bottle", command=self.bottle)
    ...
    def save(self):
        ...
        fname = self.dir_saving+'obj_'+str(self.t)+"_"+str(self.folder)+'.txt'
        ...
        for obj in self.all_objects:
            ...
            cv2.imwrite(self.dir_saving+'obj_'+str(self.t)+"_"+str(self.folder)+'.jpg',img)
    ...
    def pen(self):
        self.object = 'pen'; self.read_mouse=2; print 'pen';self.color = self._colors[3]
    def bottle(self):
        self.object = 'bottle'; self.read_mouse=2; print 'bottle';self.color = self._colors[1]
    def ball(self):
    ...
    def PrevVideo(self):
        ...
        while(1):
            ...
            if not os.path.isfile(fname):
                ...
                self.folder -= 1
        self.dir2 = self.dir1+'/obj_'+str(self.folder)+'/trial_1/look/vision_data/'
